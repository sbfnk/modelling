...
If needed, one can applies this to all the variables returned by `ssa.adaptivetau` and construct a data frame with model output at the desired times.
...
<div>
# Navigate
Top: [Index](index.html) Previous: [R introduction](intro_to_r_gk.html) <!-- Next: [TODO](mcmc_and_model_comparison.html) -->
</div>
