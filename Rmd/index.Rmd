...
![](ext_fig/lshtm_cmmid.png)

Welcome to the introductory material on infectious disease modelling in R. The material included here is based on the Modelling Infectious Diseases course at The Institute of Mathematical Sciences, Chennai, India, held as part of the [Workshop on Infectious Disease Modeling](http://www.imsc.res.in/~sitabhra/meetings/infection15/), 23-28 November, 2015. Below you will find the lab practical sessions, which can also be used for self-study.
...
1. [R Introduction and deterministic models](intro_to_r_gk.html)
